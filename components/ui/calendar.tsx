...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar rounded-md border border-border/60 bg-background p-2 text-foreground dark:border-white/15 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
...
function CalendarDayButton({ className, day, modifiers, locale, ...props }: any) {
  const defaultClassNames = getDefaultClassNames()
