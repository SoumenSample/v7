...
// //   // ── KEY FIX: measure button position relative to the <nav> (not <ul>) ──
...
// //   // ── Position indicator under the initially-active item on mount ──
// //   useLayoutEffect(() => {
...
// //           background: rgba(${color === "#00fffc" ? "0,255,252" : "6,182,212"}, 0.08);
// //         }
...
// //               >
// //                 {/* ── The button that drives the sparkle indicator ── */}
// //                 <button
// //                   ref={(el) => { buttonRefs.current[index] = el; }}
// //                   className="sparkle-nav__btn"
// //                   onClick={() => {
// //                     handleClick(index);
// //                     // Also navigate — wrap in router.push if using Next.js router
...
// //         {/* ── Sparkle indicator lives inside <nav>, not <ul> ── */}
...
//           box-shadow: 0 24px 80px rgba(0, 0, 0, 0.75), 0 0 0 1px rgba(0,255,252,0.04) inset;
//           z-index: 9999;
